...
tape("line.curve(curveCardinal.tension(tension)) uses the specified tension", function(test) {
  test.equal(shape.line().curve(shape.curveCardinal.tension(0.5))([[0, 1], [1, 3], [2, 1], [3, 3]]), "M0,1C0,1,0.8333333333333334,3,1,3C1.1666666666666667,3,1.8333333333333333,1,2,1C2.1666666666666665,1,3,3,3,3");
  test.end();
});
...
tape("area.curve(curveCardinal.tension(tension)) uses the specified tension", function(test) {
  test.equal(shape.area().curve(shape.curveCardinal.tension(0.5))([[0, 1], [1, 3], [2, 1], [3, 3]]), "M0,1C0,1,0.8333333333333334,3,1,3C1.1666666666666667,3,1.8333333333333333,1,2,1C2.1666666666666665,1,3,3,3,3L3,0C3,0,2.1666666666666665,0,2,0C1.8333333333333333,0,1.1666666666666667,0,1,0C0.8333333333333334,0,0,0,0,0Z");
  test.end();
});
