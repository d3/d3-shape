...
tape("line.step(\"basis-closed\")(data) generates the expected path", function(test) {
  ...
  test.equal(l([]), "");
  test.equal(l([[0, 0]]), "M0,0C0,0,0,0,0,0");
  test.equal(l([[0, 0], [0, 10]]), "M0,6.666666666666667C0,6.666666666666667,0,3.3333333333333335,0,3.3333333333333335C0,3.3333333333333335,0,6.666666666666667,0,6.666666666666667");
